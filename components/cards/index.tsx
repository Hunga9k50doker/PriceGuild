...
const Cards = <T,>({
  ...
  return (
    <div className="row row-list mt-30">
      {Boolean(isTable) && Boolean(isInline) ? (
        <div id="table-container" className="content-pricing-grid p-0 table-responsive customScroll content-pricing-grid-custom">
          <table className="table table-striped table-hover table-sort">
              ...
              <tr>
                <th className="text-center" scope="col" style={{ width: "4%" }}>
                  <div className="w-100 h-100">
                    <input
                      onChange={() => {
                        isCheckAll ? onClear && onClear() : onSelectAll && onSelectAll();
                      }}
                      checked={isCheckAll}
                      className="form-check-input form-check-input-head cursor-pointer border-checkbox"
                      type="checkbox"
                      readOnly
                    />
                  </div>
                ...
                <th scope="col" style={{ width: "8%" }}>
                  <div
                    className="d-flex cursor-pointer align-items-center white-space-nowrap"
                    onClick={() => onSortTable && onSortTable("onCardCode")}
                  >
                    Card No.
                ...
                {isPortfolioAll && (
                  <th scope="col" style={{ width: "10%" }}>
                    <div onClick={() => onSortTable && onSortTable("group_name")} className="d-flex cursor-pointer align-items-center">
                      Portfolio
                ...
                <th scope="col" style={{ width: "10%" }}>
                  <div onClick={() => onSortTable && onSortTable("latest_price")} className="d-flex cursor-pointer align-items-center">
                    Latest
                ...
                <th scope="col" style={{ width: "4%" }}>
                  <div onClick={() => onSortTable && onSortTable("minPrice")} className="d-flex cursor-pointer align-items-center">
                    Min
                    <div className="ms-1 sort-table d-flex flex-column-reverse">
                ...
                <th scope="col" style={{ width: "10%" }}>
                  <div onClick={() => onSortTable && onSortTable("maxPrice")} className="d-flex cursor-pointer align-items-center">
                    Max
                    <div className="ms-1 sort-table d-flex flex-column-reverse">
                ...
                <th scope="col" style={{ width: "10%" }}>
                  <div onClick={() => onSortTable && onSortTable("average_price")} className="d-flex cursor-pointer align-items-center ">
                    Average
                    <div className="ms-1 sort-table d-flex flex-column-reverse">
            ...
            <tbody>
              ...
              {props.isLoading &&
                Array.from(Array(28).keys()).map((e, index) => (
                  <tr key={index}>
          ...
          <>
            {isProfile && nameSearch === "" && props.cards.length === 0 && isEmpty(dataFilterStore) ? (
              <>
                ...
                <div ref={cardNoDataRef} className="d-none">
      ...
      <div className="col-lg-12 text-center">
        <div className="pagination__option">
          {props.isLoadMore && (
            <button onClick={props.onLoadMore} className="btn  btn-load-more" type="button" disabled={props.isLoading}>
              {props.isLoading ? (
                <>
