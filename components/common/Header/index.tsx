...
import IconArrowLanguage from "./IconArrowLanguage";
import SearchMobileModal from "./searchMobile";
...
const Header = (props: any) => {
  ...
  const goToCollections = (sportName: string) => {
    history.push(`/collections/${sportName}`);
  }
  ...
  return (
    <div className="position-relative container-fluid header-page-content">
      ...
      <Link to="/">
        <img alt="" onClick={() => history.push("/")} className="image-logo cursor-pointer image-logo-1440" src={logoHeader} />
        <img alt="" onClick={() => history.push("/")} className="image-logo cursor-pointer  image-logo-1024" src={logoHeader1024} />
      </Link>
              ...
              <div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul className="navbar-nav mb-lg-0">
                  <li className="nav-item">
                    <Link to="/top-100" className="nav-link" aria-current="page" title="Top 100"> Top 100 </Link>
                  </li>
                  <li className="nav-item">
                    <Link to="/rookie-cards" className="nav-link" aria-current="page" title="Rookie Cards"> Rookie Cards </Link>
                  </li>
                  <li className="nav-item">
                    <Link to="/leaderboard" className="nav-link" aria-current="page" title="Leaderboard"> Leaderboard </Link>
                  </li>
                  <li className="nav-item nav-item--blog">
                    <Link to="/blog" className="nav-link" aria-current="page" title="Blog"> Blog </Link>
                  </li>
                  <li className="nav-item">
                    <Link className="nav-link" aria-current="page" to={`/faq`} title="FAQ"> FAQ </Link>
                  </li>
                  <li className="nav-item">
                    <Link to="/glossary" className="nav-link" aria-current="page" title="Glossary"> Glossary </Link>
                  </li>
                  <li className="nav-item">
                    <Link className="nav-link" to={`/about`} title="About"> About </Link>
                  </li>
                  <li className="nav-item nav-item--contact">
                    <Link className="nav-link" aria-current="page" to={`/contact`} title="Contact"> Contact </Link>
                  </li>
            ...
            <div className="mobile-nav">
              {!isShow ?
                <div className="section-logo">
                  <Link to="/" title="">
                    <img alt="" onClick={() => history.push("/")} className="image-logo-mobile cursor-pointer" src={IconMobileLogo} />
                  </Link>
                </div> : ''}
          ...
          <nav className="position-unset navbar navbar-main navbar-expand-sm navbar-light">
            <div className="w-100">
              ...
              <div className="browse collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                ...
                {(location.pathname !== "/" && location.pathname.split("/")[1] !== "sport") && <div className={`smart-search`}>
                  ...
                  {loggingIn ? <>
                    <li className="nav-item dropdown user">
                      ...
                      <ul className="dropdown-menu dropdown-user-login" aria-labelledby="navbarDropdown">
                        <li >
                          <Link className="dropdown-item user-login-info" to="/profile/personal"> {userInfo?.firstname} {userInfo?.lastname}<div className="user-login-info-name"> @{userInfo?.username} </div> </Link>
                        </li>
                        <li><hr className="dropdown-divider" /></li>
                        <li>
                          <Link className="dropdown-item" to="/profile/personal" title="Profile"> <span><img alt="Profile" src={IconUserProfile} /></span> Profile </Link>
                        </li>
                        <li>
                          <Link className="dropdown-item" to="/profile/portfolio" title={t('portfolio.text_upper')}>
                            <span> <img alt={t('portfolio.text_upper')} src={IconCollectionProfile} /> </span> {t('portfolio.text_upper')}
                          </Link>
                        </li>
                        <li>
                          <Link className="dropdown-item" to="/profile/wishlists" title="Wishlists">
                            <span> <img src={IconHeartProfile} alt="Wishlists"/> </span> Wishlists
                          </Link>
                        </li>
                        <li>
                          <Link className="dropdown-item" to="/profile/friends" title="Friends">
                            <span> <img src={IconFriendProfile} alt="Friends" /> </span> Friends
                          </Link>
                        </li>
                        <li>
                          <Link className="dropdown-item" to="/profile/messages" title="Messages">
                            <span> <img src={IconMessageProfile} alt="Messages" /> </span> Messages
                          </Link>
                        </li>
                        {/* <li>
                        ...
                        <li><hr className="dropdown-divider" /></li>
                        <li>
                          <Link className="dropdown-item" to="/profile/settings" title="Settings">
                            <span> <img src={IconSettingProfile} alt="Settings" /> </span> Settings
                          </Link>
                        </li>
                        <li>
                          <Link className="dropdown-item" to="/profile/help" title="Can't find a card?">
                            <span> <img src={IconCartProfile} alt="Can't find a card?" /> </span> Can't find a card?
                          </Link>
                        </li>
                        <li>
                          <Link className="dropdown-item" to="/profile/api" title="API">
                            <span className="custom-icon-span"> <img src={IconCloudProfile} alt="API" /> </span> API
                          </Link>
                        </li>
                        <li><hr className="dropdown-divider" /></li>
                        <li onClick={logout}>
                          <a className="dropdown-item" href="javascript:void(0)" title="Logout">
                            <span> <img src={IconLogout} alt="Logout" /> </span> Logout
                          </a>
                        </li>
                      </ul>
                    </li>
                    ...
                    <li className="nav-item nav-item--register">
                      <Link className="nav-link active" aria-current="page" to="/register" title="Create Account"> Create Account </Link>
                    </li> </>}
                </ul>
              </div>
            </div>
      ...
      <div className={`${showMenuContent?'active':''} section-menu-content`}>
        ...
        {!loggingIn ?
          <div className="section-account">
            <button className="btn-login btn btn-primary">
              <Link to="/login" onClick={() => { setShowMenuContent(false) }} title="Login"> Login </Link>
            </button>
            <button className="btn-create-account btn">
              <Link to="/register" onClick={() => { setShowMenuContent(false) }} title="Create Account"> Create Account </Link>
            </button>
          </div> :
        ...
        <div className="menu-data">
          <ul className="main-menu">
            <li> <Link to="/" onClick={() => { setShowMenuContent(false) }} title="Home"> Home </Link> </li>
            ...
            <li> <Link to="/comparison" onClick={() => { setShowMenuContent(false) }} title=""> Comparison {Boolean(cards.length) && <span className="bagde">{cards.length}</span>} </Link> </li>
          </ul>
          <ul className="belong-menu">
            <li> <Link to="/top-100" onClick={() => { setShowMenuContent(false) }} title="Top 100"> Top 100 </Link> </li>
            <li> <Link to="/rookie-cards" onClick={() => { setShowMenuContent(false) }} title="Rookie Cards"> Rookie Cards </Link> </li>
            <li> <Link to="/leaderboard" onClick={() => { setShowMenuContent(false) }} title="Leaderboard"> Leaderboard </Link> </li>
            <li> <Link className="text-reset text-decoration-none" to={`/blog`} title="Blog"> Blog </Link> </li>
            <li> <Link className="text-reset text-decoration-none" to={`/faq`} title="FAQ"> FAQ </Link> </li>
            <li> <Link className="text-reset text-decoration-none" to={`/about`} title="About"> About </Link> </li>
            <li> <Link className="text-reset text-decoration-none" to={`/contact`} title="Contact"> Contact </Link> </li>
          </ul>
        </div>
      </div> 
        ...
        <div className="section-profile">
          ...
          <div className="section-profile-info">
            <ul className="account-profile">
              <li>
                <Link title="Profile" className="dropdown-item" to="/profile/personal" onClick={() => { setShowProfileContent(false) }}>
                  <span><img src={IconUserProfile} alt="Profile" /></span>
                  <span className="text-title"> Profile </span>
                </Link>
              </li>
              <li>
                <Link title={t('portfolio.text_upper')} className="dropdown-item" to="/profile/portfolio" onClick={() => { setShowProfileContent(false) }}>
                  <span><img src={IconCollectionProfile} alt={t('portfolio.text_upper')} /></span>
                  <span className="text-title"> {t('portfolio.text_upper')} </span>
                </Link>
              </li>
              <li>
                <Link title="Wishlists" className="dropdown-item" to="/profile/wishlists" onClick={() => { setShowProfileContent(false) }}>
                  <span> <img src={IconHeartProfile} alt="Wishlists" /> </span>
                  <span className="text-title"> Wishlists </span>
                </Link>
              </li>
              <li>
                <Link title="Friends" className="dropdown-item" to="/profile/friends" onClick={() => { setShowProfileContent(false) }}>
                  <span> <img src={IconFriendProfile} alt="Friends" /> </span>
                  <span className="text-title"> Friends </span>
                </Link>
              </li>
              <li>
                <Link title="Messages" className="dropdown-item" to="/profile/messages" onClick={() => { setShowProfileContent(false) }}>
                  <span> <img src={IconMessageProfile} alt="Messages" /> </span>
              ...
              <li><hr className="dropdown-divider" /></li>
              <li>
                <Link title="Settings" className="dropdown-item" to="/profile/settings" onClick={() => { setShowProfileContent(false) }}>
                  <span> <img src={IconSettingProfile} alt="Settings" /> </span>
                  <span className="text-title"> Settings </span>
                </Link>
              </li>
              <li>
                <Link title="Can't find a card?" className="dropdown-item" to="/profile/help" onClick={() => { setShowProfileContent(false) }}>
                  <span> <img src={IconCartProfile} alt="Can't find a card?" /> </span>
                  <span className="text-title"> Can't find a card? </span>
                </Link>
              </li>
              <li>
                <Link title="API" className="dropdown-item" to="/profile/api" onClick={() => { setShowProfileContent(false) }}>
                  <span className="custom-icon-span"> <img src={IconCloudProfile} alt="API" /> </span>
                  <span className="text-title"> API </span>
                </Link>
              </li>
              <li><hr className="dropdown-divider" /></li>
              <li onClick={() => { logout(); setShowProfileContent(false) }}>
                <a title="Logout" className="dropdown-item" href="javascript:void(0)"> <span> <img src={IconLogout} alt="Logout" /> </span> Logout </a>
              </li>
            </ul>
          </div>
        </div>}
