      ...
      <div className="row">
              ...
              {isLoading ? (
                ...
                <>
                  {cardData?.fullNameWithCode ? (
                    <input type="text" readOnly className="form-control-plaintext" value={cardData?.fullNameWithCode} />
                  ) : (
                    <Skeleton style={{ width: 100 }} />
                  )}
                </>
              ...
              {isLoading ? (
                ...
                <>
                  {cardData?.publisher?.name ? (
                    <input type="text" readOnly className="form-control-plaintext" value={cardData?.publisher?.name} />
                  ) : (
                    <Skeleton style={{ width: 100 }} />
                  )}
                </>
          ...
          <div className="row picture-box-data">
            ...
            <div className="col-8 col-sm-9">
              {isLoading ? (
                ...
                <>
                  {cardData?.type.name ? (
                    <input type="text" readOnly className="form-control-plaintext" value={cardData?.type?.name} />
                  ) : (
                    <Skeleton style={{ width: 100 }} />
                  )}
                </>
          ...
          <div className="row picture-box-data">
            ...
            <div className="col-8 col-sm-9">
              {isLoading ? (
                ...
                <>
                  {cardData?.color.name ? (
                    <input type="text" readOnly className="form-control-plaintext" value={cardData?.color.name} />
                  ) : (
                    <Skeleton style={{ width: 100 }} />
                  )}
                </>
        ...
        <div className="col-12 col-md-6 col-lg-6 col-xl-6 content-break-down">
          ...
          <div className="data-chart-info">
            <div className="row bold-chart-text">
              ...
              <div className="col-4 col-sm-6 value-input">
                {cardPrice?.change ? (
                  <input type="text" readOnly className="form-control-plaintext" value={`+${formatNumber(cardPrice?.change)}%`} />
                ) : (
                  <Skeleton style={{ width: 100 }} />
                )}
              </div>
            ...
            <div className="row">
              ...
              <div className="col-4 col-sm-6 value-input">
                {cardPrice?.latest ? (
                  <input type="text" readOnly className="form-control-plaintext" value={formatCurrency(cardPrice?.latest, currency)} />
                ) : (
                  <Skeleton style={{ width: 100 }} />
                )}
              </div>
            ...
            <div className="row">
              ...
              <div className="col-4 col-sm-6 value-input">
                {cardPrice?.min ? (
                  <input type="text" readOnly className="form-control-plaintext" value={formatCurrency(cardPrice?.min, currency)} />
                ) : (
                  <Skeleton style={{ width: 100 }} />
                )}
              </div>
            ...
            <div className="row">
              ...
              <div className="col-4 col-sm-6 value-input">
                {cardPrice?.max ? (
                  <input type="text" readOnly className="form-control-plaintext" value={formatCurrency(cardPrice?.max, currency)} />
                ) : (
                  <Skeleton style={{ width: 100 }} />
                )}
              </div>
            ...
            <div className="row">
              ...
              <div className="col-4 col-sm-6 value-input">
                {cardPrice?.average ? (
                  <input type="text" readOnly className="form-control-plaintext" value={formatCurrency(cardPrice?.average, currency)} />
                ) : (
                  <Skeleton style={{ width: 100 }} />
                )}
              </div>
            ...
            <div className="row">
              ...
              <div className="col-4 col-sm-6 value-input">
                {cardPrice?.total_trades ? (
                  <input type="text" readOnly className="form-control-plaintext" value={cardPrice?.total_trades} />
                ) : (
                  <Skeleton style={{ width: 100 }} />
                )}
              </div>
          ...
          <div className="d-flex justify-content-around section-detail-btn">
            ...
            <button
              onClick={() => router.push(`/search/?sport_criteria=${cardData?.sport?.id}`)}
              className="btn btn-primary btn-see-all"
              title="See All Baseball Cards"
            >
