  ...
  _createClass(Autosuggest, [
    ...
    },
    {
      ...
      value: function onEnter() {
        var _this$props$inputProp = this.props,
          onEnter = _this$props$inputProp.onEnter;
        if (onEnter) {
          onEnter();
        }
      },
    ...
    },
    {
      ...
      value: function getQuery() {
        ...
        if (valueBeforeUpDown === null) {
          // console.log(typeof value === "string", value,lableName);
          return typeof value === "string"
            ? value.trim()
            : value?.[labelName].trim();
        }
        return typeof valueBeforeUpDown === "string"
          ? valueBeforeUpDown.trim()
          : valueBeforeUpDown?.[labelName].trim();
      },
    },
    {
      key: "render",
