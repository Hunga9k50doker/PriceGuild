...
const ParameterTitle = ({ type }: PropTypes) => {
  ...
  return (
    <div className="col-6 ps-4">
      ...
      <div className="row">
        <label className="col-sm-3 col-form-label">Sport:</label>
        <div className="col-sm-9">
      ...
      <div className="row">
        <label className="col-sm-3 col-form-label">Includes:</label>
        <div className="col-sm-9">
          <span className="form-control-plaintext text-decoration-underline" ><Skeleton width={200} /></span>
        </div>
      </div>
      <div className="row">
        <label className="col-sm-3 col-form-label">Cards in Checklist:</label>
        <div className="col-sm-9">
          <span className="form-control-plaintext text-decoration-underline" ><Skeleton width={200} /></span>
        </div>
      </div>
      {Boolean(type !== "base") && <>
        <div className=" row">
          <label className="col-sm-3 col-form-label">Base/Insert:</label>
          <div className="col-sm-9">
            <span className="form-control-plaintext" ><Skeleton width={200} /></span>
          </div>
        </div>
        <div className="row">
          <label className="col-sm-3 col-form-label">Cards in Collection:</label>
          <div className="col-sm-9">
            <span className="form-control-plaintext" ><Skeleton width={200} /></span>
          </div>
        </div>
