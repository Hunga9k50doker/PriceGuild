...
const Header = (props: any) => {
  ...
  const onRedirectCard = (urlObject: any) => {
    const str = Object.entries(urlObject)
      .map(([key, val]) => `${key}=${val}`)
      .join("&");
  ...
  useEffect(() => {
    dispatch(MaintenanceAction.getListMaintenance(dispatch));
  }, []);
    ...
    if (maintenanceList?.length) {
      ...
      switch (dataMaintenance.type) {
        case 2:
          ...
          break;
        case 1:
          setMaintenanceStatus(dataMaintenance);
          break;
        case 3:
    ...
    <div className="position-relative container-fluid header-page-content">
      ...
      {isShowMessage && (
        <div className="alert alert-maintenance" role="alert">
          ...
          <div className="content" dangerouslySetInnerHTML={{ __html: maintenanceStatus.message }} />
          <span onClick={() => setIsShowMessage(false)}>
              ...
              <div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                <ul className="navbar-nav mb-lg-0">
                  ...
                  <li className="nav-item nav-item--usd">
                    <a className="nav-link" aria-current="page" href="#" title="EN">
                      EN <IconArrowLanguage />
                    </a>
                  </li>
                </ul>
              </div>
              ...
              <div className="section-nav-menu">
                {!isShow ? (
                  ...
                  <span
                    ...
                    onClick={() => {
                      setIsShow(false);
                      inputSearchRefs?.current?.onClearData();
                    }}
                  >
                    Cancel
                  </span>
          ...
          <nav className="position-unset navbar navbar-main navbar-expand-sm navbar-light">
            <div className="w-100">
              ...
              <div className="browse collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                ...
                <a
                  title="Browse"
                  className="button-browse nav-link me-2 btn btn-sm btn-secondary"
                    ...
                    <div className="row">
                      <div className="col-xxl-8 col-md-7">
                        ...
                        <div className="d-flex flex-wrap">
                          {sports.map((item, k) => (
                            <div key={k} className="mb-3 cursor-pointer" onClick={() => onSearchCardBySport(item.id)}>
                              <div className="d-flex text-center justify-content-between align-items-center browse-item flex-column">
                                <div className="browse-item-icon w-100 d-flex justify-content-center align-items-center">
                                  <div className="browse-item-icon__img">
                      ...
                      <div className="col-xxl-4 col-md-5 popular-publisher-header">
                        ...
                        <div className="header-nav mt-2 d-flex">
                          <div
                            className="col nav popular-publisher-item flex-column nav-pills"
                            id="v-pills-tab"
                            role="tablist"
                            ...
                            {popularPublishers?.map((item, key) => (
                              ...
                              >
                                {item.sports.map((sport, index) => (
                                  <div onClick={() => onSearchCard(sport, item.publisher)} className="cursor-pointer border-under" key={index}>
                                    {sport.sportName}
                                  </div>
                                ))}
                                <div className="nav-pills-image mb-4 d-flex justify-content-center align-items-center">
                                  <div className="nav-pills-image-item">
                                    <img
                                      alt=""
                                      id={`error-image-header${key}`}
                                      className="img-publisher"
                                      src={item.publisher.image}
                                      onError={(e) => handleError(e, key)}
                                    />
                                    <span className="text-publisher">{handleTextError(item.publisher.name)}</span>
                                  </div>
                                </div>
                              </div>
                            ))}
                ...
                {router.pathname !== "/" && router.pathname.split("/")[1] !== "sport" && (
                ...
                <ul className="collection navbar-nav mt-0 mb-2 mb-lg-0 align-items-center justify-content-end">
                  <li className="nav-item position-relative dropdown">
                    <a
                      className="nav-link nav-link--collection dropdown-toggle"
                      href="#"
                      id="navbarDropdown"
                      role="button"
                      data-bs-toggle="dropdown"
                    ...
                    <div className="dropdown-menu collection-content  py-0 mt-0 " aria-labelledby="navbarDropdown">
                      <div className="col-12">
                        <div className="d-flex flex-wrap p-3">
                          {sports.map((item, k) => (
                            <Link href={goToCollectionsLink(item?.sportName?.replace(/\s/g, "").toLowerCase())} key={k}>
                    ...
                    <>
                      <li className="nav-item dropdown user">
                        <a
                          ...
                          aria-expanded="false"
                        >
                          <img className="w-38" src={UserPicture} alt="" title="" />
                        </a>
                        <ul className="dropdown-menu dropdown-user-login" aria-labelledby="navbarDropdown">
                          <li>
                            <Link href="/profile/personal">
                              <a className="dropdown-item user-login-info">
                                {userInfo?.firstname} {userInfo?.lastname} <div className="user-login-info-name"> @{userInfo?.username} </div>
                              </a>
                            </Link>
                          </li>
                          <li>
                          ...
                          <li>
                            <Link href="/profile/personal">
                              <a className="dropdown-item" title="Profile">
                                <span>
                                  <img alt="Profile" src={IconUserProfile} />
                                </span>
                                Profile
                              </a>
                            </Link>
                          ...
                          <li>
                            <Link href="/profile/portfolio">
                              <a className="dropdown-item" title={t("portfolio.text_upper")}>
                                <span>
                                  <img alt={t("portfolio.text_upper")} src={IconCollectionProfile.src} />
                                </span>
                          ...
                          <li>
                            <Link href="/profile/wishlists">
                              <a className="dropdown-item" title="Wishlists">
                                <span>
                                  <img src={IconHeartProfile.src} alt="Wishlists" />
                                </span>
                                Wishlists
                              </a>
                            </Link>
                          ...
                          <li>
                            <Link href="/profile/friends">
                              <a className="dropdown-item" title="Friends">
                                <span>
                                  <img src={IconFriendProfile.src} alt="Friends" />
                                </span>
                                Friends
                              </a>
                            </Link>
                          ...
                          <li>
                            <Link href="/profile/messages">
                              <a className="dropdown-item" title="Messages">
                                <span>
                                  <img src={IconMessageProfile.src} alt="Messages" />
                                </span>
                                Messages
                              </a>
                            </Link>
                          ...
                          <li>
                            <Link href="/profile/settings">
                              <a className="dropdown-item" title="Settings">
                                <span>
                                  <img src={IconSettingProfile.src} alt="Settings" />
                                </span>
                                Settings
                              </a>
                            </Link>
                          ...
                          <li>
                            <Link href="/profile/help">
                              <a className="dropdown-item" title="Can't find a card?">
                                <span>
                                  <img src={IconCartProfile.src} alt="Can't find a card?" />
                                </span>
                                Can't find a card?
                              </a>
                            </Link>
                            ...
                            <Link href="/profile/api">
                              <a className="dropdown-item" title="API">
                                <span className="custom-icon-span">
                                  <img src={IconCloudProfile.src} alt="API" />
                                </span>
                                API
                              </a>
                            </Link>
                          ...
                          <li onClick={logout}>
                            <a className="dropdown-item" href="javascript:void(0)" title="Logout">
                              <span>
                                <img src={IconLogout.src} alt="Logout" />
                              </span>
                              Logout
                            </a>
                          </li>
      ...
      <div className={`${showMenuContent ? "active" : ""} section-menu-content`}>
        <div className="section-logo-nav">
          <div className="d-flex justify-content-between section-logo">
            ...
            <img
              src={IconCloseNavMenu}
              alt="IconCloseNavMenu"
        ...
        <div className="menu-data">
          <ul className="main-menu">
            ...
            <li
              ...
              title="Collections"
            >
              Collections <img src={IconArrowNavMenu} alt="IconArrowNavMenu" className="icon-arrow" />
            </li>
            <li>
          ...
          <ul className="belong-menu">
            ...
            <li>
              <Link href={`/contact`}>
                <a className="text-reset text-decoration-none" title="Contact">
                  Contact
                </a>
              </Link>
            </li>
        ...
        <div className="box-title">
          <div className="section-title">
            {!tabColl ? (
              <>
                <img
                  src={IconArrowBackMenu}
                  onClick={() => {
                    setShowCollectionMenu(false);
                    menuActive();
                  }}
                  alt="IconArrowBackMenu"
        ...
        <div className="content-menu-collection">
          <ul className="menu-collection">
            {sports.map((item, k) => (
              <li
                onClick={() => {
                  goToCollections(item?.sportName?.replace(/\s/g, "").toLowerCase());
                  setShowCollectionMenu(false);
                  setShowMenuContent(false);
                }}
              >
      ...
      {is_show_tab_bar && (
        <div className="tab-bottom">
          <div className="tab-navigation d-flex justify-content-around">
            ...
            <div
              className="d-flex flex-column tab-item"
              onClick={() => {
                setTabColl(true);
                setShowCollectionMenu(true);
              }}
            ...
            <ul className="account-profile">
              <li>
                <Link href="/profile/personal">
                  ...
                  >
                    <span>
                      <img src={IconUserProfile.src} alt="Profile" />
                    </span>
              ...
              <li>
                <Link href="/profile/portfolio">
                  ...
                  >
                    <span>
                      <img src={IconCollectionProfile.src} alt={t("portfolio.text_upper")} />
                    </span>
              ...
              >
                <a title="Logout" className="dropdown-item" href="javascript:void(0)">
                  <span>
                    <img src={IconLogout.src} alt="Logout" />
                  </span>
                  Logout
      ...
      <div className={`${is_browse ? "active" : ""} section-bowse`}>
          ...
          <div className="section-title">
            <div className="d-flex justify-content-between align-items-center w-100">
              ...
              <span
                ...
                onClick={() => {
                  setTabColl(false);
                  dispatch(ConfigAction.updateBrowse(false));
                }}
              >
                Close
              </span>
        ...
        <div className="row section-bowse-item">
          {sports.map((item, k) => (
            <div
              key={k}
              className="col-6 col-md-4 mb-3 cursor-pointer section-bowse-item-detail"
              onClick={() => {
                onSearchCardBySport(item.id);
                dispatch(ConfigAction.updateBrowse(false));
              }}
            >
              <div className="d-flex text-center justify-content-between align-items-center browse-item flex-column">
