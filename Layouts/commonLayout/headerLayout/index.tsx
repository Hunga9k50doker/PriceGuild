...
const Header = (props: any) => {
  ...
  const [showToggleBackdrop, setToggleBackdrop] = useState<boolean>(false);
          ...
          <nav className="position-unset navbar navbar-main navbar-expand-sm navbar-light">
            <div className="w-100">
              ...
              <div className="browse collapse navbar-collapse justify-content-between" id="navbarSupportedContent">
                ...
                <a title="Browse" className="button-browse nav-link me-2 btn btn-sm btn-secondary" href="javascript:void(0)" id="navbarDropdownBrowse" role="button" data-bs-toggle="dropdown" aria-expanded="false" onClick={toggleBackdrop()}>
