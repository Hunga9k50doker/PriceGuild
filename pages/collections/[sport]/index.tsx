...
const CollectionList = (props: PropTypes) => {
  ...
  // const [publishers, setPublishers] = useState<Array<FilterType>>([]);
  ...
  //   try {
  //     const result = await api.v1.getFilterPublisher({
  //       sport_id: query?.sport || 0,
  //     });
  //     if (result.success) {
  //       return setPublishers(
  //         convertListDataToGrouped(
  ...
  // const onLoadMore = () => {
  //   if (currentPage + 1 <= Math.ceil((data.rows ?? 0) / rowsPerPage)) {
  //     getListCard(currentPage + 1, false);
  ...
  //   getListCard(event.selected + 1, false);
