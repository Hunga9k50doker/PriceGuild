  ...
  const renderContent = () => {
        ...
        case "portfolio":
          return (
            <div className="col-12 col-md-12 min-vh-100 container-collection">
              <Collection key={"collections"} userId={Number(page)} isButtonRight={false} isEdit={false} isProfileFriend={true} />
            </div>
          );
        case "wishlists":
    ...
    switch (page) {
      ...
      case "collections":
        ...
        if (action === "edit-card") {
          return (
            <div className="col-12 col-md-10 min-vh-100 col-edit-card clear-padding clear-padding-add">
              <AddCard isEdit={true} />
            </div>
          );
        }
