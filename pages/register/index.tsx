...
const RegisterPage: React.FC = () => {
  ...
  const validationSchema = Yup.object().shape({
    ...
    username: Yup.string()
      ...
      .min(
        3,
        "Usernames can only contain letters of the alphabet, numbers, -,  _ and a minimum of 3 characters"
      )
      .max(
        150,
        "Usernames can only contain letters of the alphabet, numbers, -,  _, a minimum of 3 and a maximum of 150 characters"
      )
      .matches(
        RegexString.username,
        "Usernames can only contain letters of the alphabet, numbers, - and _"
      )
  ...
  return (
    <div className="container authenticate-page">
      <Head>
        ...
        <meta
          name="description"
          content="Create a new Account at Price Guide.Cards"
        />
      </Head>
      <div className="">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="row g-3">
              ...
              <div
                className={`col-12 form-data ${
                  errors.firstName ? "error-validation" : ""
                }`}
              >
              ...
              <div
                className={`col-12 form-data ${
                  errors.lastName ? "error-validation" : ""
                }`}
              >
              ...
              >
                ...
                <div className="position-password  position-relative">
                  ...
                  <div
                    ...
                    className="btn position-absolute position-password--custom"
                  >
              ...
              <div className="col-12">
                ...
                <label htmlFor="agreeTerms" className="form-check-label">
                  I agree to{" "}
                  <span className="color-blue">Terms and Conditions</span>
                </label>
              </div>
              <div className="col-12 mt-0">
                <input
                  ...
                  id="agreeNewsLetter"
                />
                <label htmlFor="agreeNewsLetter" className="form-check-label">
              ...
              <div className="col-12 d-grid gap-2">
                <button
                  disabled={!watchAgreeTerms || !token || isLoading}
              ...
              <div className="col-12 mt-4">
                <p className="text-center mb-0 no-credit">
