...
export class AuthActions {
  static login(payload: AuthenticationApi.LoginParamType, onSuccess: () => void, headers: any, router: any, onFail: () => void) {
    return {
  ...
  static register(payload: AuthenticationApi.RegisterParamType, headers: any, router: any, onFail: () => void) {
    return {
